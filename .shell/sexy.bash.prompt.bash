...
PROMPT_USER_COLOR="$(tput bold)$(tput setaf 6)"
PROMPT_DEVICE_COLOR="$(tput bold)$(tput setaf 5)"
PROMPT_DIR_COLOR="$(tput bold)$(tput setaf 3)"
PROMPT_GIT_STATUS_COLOR="$(tput bold)$(tput setaf 2)"
PROMPT_GIT_PROGRESS_COLOR="$(tput bold)$(tput setaf 4)"
